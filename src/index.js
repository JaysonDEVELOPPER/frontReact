...
const router = createBrowserRouter([
  // Assurez-vous que ces composants sont exportés correctement dans leurs fichiers respectifs
  ...
  { path: "/detail-client", element: <DetailClientAdminPage /> },
  { path: "/update-client", element: <UpdateClientAdminPage /> },
